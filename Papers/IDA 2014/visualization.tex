...
\begin{figure*}%
  % TODO: remove the `BioMaps' title on the top-left. Also for other images.
  \centering%
...
\begin{figure*}%
  ...
  \subfigure[Blood vessel connections within the heart]{
    %\includegraphics[width=5.8cm]{images/force-7096b.png}
    %\label{fig:force-7096}
    \hskip5.8cm
    % TODO: Insert screenshot of blood-vessel connections (inside the heart) from the actual prototype
  }%
  \MH{}{Natallia, could you blend the tile-background with 30\% transparency (or whiteness)? You can also just take a screenshot of the prototype after checking `Connections'.}
